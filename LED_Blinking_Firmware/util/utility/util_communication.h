...
class communication_base
{
  public:
    ...
    template <typename send_iterator_type> bool send_n(send_iterator_type first, send_iterator_type last)
    {
    ...
    template <typename recv_iterator_type> bool recv_n(recv_iterator_type first, size_type count)
    {
    ...
    template <typename recv_iterator_type> bool recv_n(recv_iterator_type first, recv_iterator_type last)
    {
...
class communication : public communication_base
{
  ...
  protected:
    communication() : send_buffer(), recv_buffer()
    {
    }
...
template <const std::size_t buffer_size> communication<buffer_size>::~communication()
{
}
} // namespace util
