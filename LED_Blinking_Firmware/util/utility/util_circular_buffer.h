...
class circular_buffer
{
  public:
    ...
    circular_buffer(const T &value = value_type(), const size_type count = size_type(0U))
    ...
    circular_buffer(const circular_buffer &other) : in_ptr(other.in_ptr), out_ptr(other.out_ptr)
    {
    ...
    size_type size() const
    {
        ...
        return size_type((is_wrap == false) ? size_type(in_ptr - out_ptr) : N - size_type(out_ptr - in_ptr));
    }
...
class circular_buffer<T, std::size_t(1U)>
{
  public:
    ...
    circular_buffer(const circular_buffer &other) : data(other.data), has_data(other.has_data)
    {
    }
