...
template<typename unsigned_short_type, 
         typename unsigned_long_type = typename util::utype_helper<static_cast<unsigned>(
                                            std::numeric_limits<unsigned_short_type>::digits * 2)>::exact_type>
inline unsigned_long_type make_long(unsigned_short_type lo, unsigned_short_type hi)
{
    ...
    static_assert((std::numeric_limits<unsigned_short_type>::digits * 2) ==
                      std::numeric_limits<unsigned_long_type>::digits,
    ...
    return static_cast<unsigned_long_type>(
        static_cast<unsigned_long_type>(static_cast<unsigned_long_type>(hi)
                                        << std::numeric_limits<unsigned_short_type>::digits) |
        lo);
}
