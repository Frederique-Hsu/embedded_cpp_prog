...
namespace util
{
template <typename data_type, const unsigned bit_pos, const unsigned bit_cnt> 
struct bit_mask_multi_value
{
    ...
    static const data_type value =
        static_cast<data_type>(static_cast<data_type>(static_cast<data_type>(~static_cast<data_type>(0U)) >>
                                                      (std::numeric_limits<data_type>::digits - (bit_cnt + 1U)))
                               << bit_pos);
};

template <typename data_type, const unsigned bit_pos> 
